...
class ChannelAccessTokenApiTest extends TestCase
{
    ...
    public function testIssueStatelessChannelTokenByJWTAssertionAsync(): void
    {
        $client = Mockery::mock(ClientInterface::class);
        ...
        $api = new ChannelAccessTokenApi($client);
        $response = $api->issueStatelessChannelTokenByJWTAssertionAsync(clientAssertion: "jwtAssertionToken")->wait();
        $this->assertEquals('accessToken', $response->getAccessToken());
        $this->assertEquals(30, $response->getExpiresIn());
        $this->assertEquals('Bearer', $response->getTokenType());
    }

    public function testIssueStatelessChannelTokenByClientSecretAsync(): void
    {
        $client = Mockery::mock(ClientInterface::class);
        $client->shouldReceive('sendAsync')
            ->with(
        ...
        $api = new ChannelAccessTokenApi($client);
        $response = $api->issueStatelessChannelTokenByClientSecretAsync(clientId: "1234", clientSecret: "clientSecret")->wait();
        $this->assertEquals('accessToken', $response->getAccessToken());
        $this->assertEquals(30, $response->getExpiresIn());
        $this->assertEquals('Bearer', $response->getTokenType());
    }

    public function testIssueStatelessChannelTokenByJWTAssertionAsyncWithHttpInfo(): void
    {
        $client = Mockery::mock(ClientInterface::class);
        $client->shouldReceive('sendAsync')
            ->with(
        ...
        $api = new ChannelAccessTokenApi($client);
        [$response, $statusCode, $headers] = $api->issueStatelessChannelTokenByJWTAssertionAsyncWithHttpInfo(clientAssertion: "jwtAssertionToken")->wait();
        $this->assertEquals('accessToken', $response->getAccessToken());
        $this->assertEquals(30, $response->getExpiresIn());
        $this->assertEquals('Bearer', $response->getTokenType());
    ...
    public function testIssueStatelessChannelTokenByClientSecretAsyncWithHttpInfo(): void
    {
        $client = Mockery::mock(ClientInterface::class);
        $client->shouldReceive('sendAsync')
            ->with(
        ...
        $api = new ChannelAccessTokenApi($client);
        [$response, $statusCode, $headers] = $api->issueStatelessChannelTokenByClientSecretAsyncWithHttpInfo(clientId: "1234", clientSecret: "clientSecret")->wait();
        $this->assertEquals('accessToken', $response->getAccessToken());
        $this->assertEquals(30, $response->getExpiresIn());
        $this->assertEquals('Bearer', $response->getTokenType());
        $this->assertEquals(200, $statusCode);
