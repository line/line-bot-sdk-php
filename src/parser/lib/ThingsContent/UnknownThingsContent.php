...
/**
 * A class that represents the things content.
 *
 * If the event is not supported by this SDK, the event will be instantiate to this.
 *
 * @package LINE\Parser\ThingsContent
 */
class UnknownThingsContent extends ThingsContent
{
    /**
     * UnknownThingsContent constructor.
     *
     * @param array $event
     */
