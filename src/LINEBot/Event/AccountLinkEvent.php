...
class AccountLinkEvent extends BaseEvent
{
    ...
    {
        return array_key_exists('result', $this->event['link'])
            ? $this->event['link']['result']
            : null;
    }
     ...
     * @return string
     */
    public function getlinkNonce()
    {
        return array_key_exists('nonce', $this->event['link'])
            ? $this->event['link']['nonce']
            : null;
    }
}
