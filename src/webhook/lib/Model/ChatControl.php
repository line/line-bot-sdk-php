 ...
 */
class ChatControl implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ChatControl';
    ...
    */
    ...
    public static function fromAssocArray(?array $data): self
    {
        ...
        if (isset($data['expireAt'])) {
            $instance->setexpireAt($data['expireAt']);
        }
