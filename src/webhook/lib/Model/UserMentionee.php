...
/**
 * UserMentionee Class Doc Comment
 *
 * @category Class
 ...
 */
class UserMentionee extends Mentionee
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserMentionee';
    ...
    */
    ...
    public static function fromAssocArray(?array $data): self
    {
        ...
        if (isset($data['isSelf'])) {
            $instance->setisSelf($data['isSelf']);
        }
