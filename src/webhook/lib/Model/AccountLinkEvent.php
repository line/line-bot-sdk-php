 ...
 */
class AccountLinkEvent extends Event
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccountLinkEvent';
    ...
    */
     ...
     * Sets replyToken
     *
     * @param string|null $replyToken Reply token used to send reply message to this event. This property won't be included if linking the account has failed.
     *
     * @return self
     */
    ...
    public static function fromAssocArray(?array $data): self
    {
        ...
        if (isset($data['link'])) {
            $instance->setlink(\LINE\Webhook\Model\LinkContent::fromAssocArray($data['link']));
        }
