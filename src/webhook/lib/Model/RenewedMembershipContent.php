...
/**
 * RenewedMembershipContent Class Doc Comment
 *
 * @category Class
 * @package  LINE\Webhook
 * @author   OpenAPI Generator team
 ...
 */
class RenewedMembershipContent extends MembershipContent
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RenewedMembershipContent';
    ...
    */
     ...
     * Sets membershipId
     *
     * @param int $membershipId The ID of the membership that the user renewed. This is defined for each membership.
     *
     * @return self
     */
