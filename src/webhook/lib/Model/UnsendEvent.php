 ...
 */
class UnsendEvent extends Event
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UnsendEvent';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('unsend', $data ?? [], null);
    }
    ...
    */
     ...
     * @return self
     */
    public function setUnsend($unsend)
    {
        if (is_null($unsend)) {
            throw new \InvalidArgumentException('non-nullable unsend cannot be null');
        }
        $this->container['unsend'] = $unsend;
    ...
    /**
     * Create an instance of UnsendEvent from a dict (associative array)
     *
    ...
    public static function fromAssocArray(?array $data): self
    {
        ...
        if (isset($data['unsend'])) {
            $instance->setunsend(\LINE\Webhook\Model\UnsendDetail::fromAssocArray($data['unsend']));
        }
