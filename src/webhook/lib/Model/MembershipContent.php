...
/**
 * MembershipContent Class Doc Comment
 *
 * @category Class
 ...
 */
class MembershipContent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MembershipContent';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type Type of membership event.
     *
     * @return self
     */
    ...
    public static function fromAssocArray(?array $data): self
    {
        ...
        $discriminatorMap = [
            'joined' => JoinedMembershipContent::class,
'left' => LeftMembershipContent::class,
'renewed' => RenewedMembershipContent::class,
        ];
