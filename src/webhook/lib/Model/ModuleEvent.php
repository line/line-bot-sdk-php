...
class ModuleEvent extends Event
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ModuleEvent';
    ...
    */
    ...
    public static function fromAssocArray(?array $data): self
    {
        ...
        if (isset($data['module'])) {
            $instance->setmodule(\LINE\Webhook\Model\ModuleContent::fromAssocArray($data['module']));
        }
