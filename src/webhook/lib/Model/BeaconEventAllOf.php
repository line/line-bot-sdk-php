...
/**
 * BeaconEventAllOf Class Doc Comment
 *
 * @category Class
 * @package  LINE\Webhook
 * @author   OpenAPI Generator team
 ...
 */
class BeaconEventAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BeaconEvent_allOf';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('beacon', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['beacon'] === null) {
            $invalidProperties[] = "'beacon' can't be null";
        }
    ...
    {
        if (is_null($beacon)) {
            throw new \InvalidArgumentException('non-nullable beacon cannot be null');
        }
