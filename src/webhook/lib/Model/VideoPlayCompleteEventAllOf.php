 ...
 */
class VideoPlayCompleteEventAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'VideoPlayCompleteEvent_allOf';
