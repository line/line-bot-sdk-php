...
/**
 * JoinedMembershipContent Class Doc Comment
 *
 * @category Class
 * @package  LINE\Webhook
 * @author   OpenAPI Generator team
 ...
 */
class JoinedMembershipContent extends MembershipContent
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'JoinedMembershipContent';
    ...
    */
     ...
     * Sets membershipId
     *
     * @param int $membershipId The ID of the membership that the user joined. This is defined for each membership.
     *
     * @return self
     */
