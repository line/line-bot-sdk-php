...
/**
 * ModuleContent Class Doc Comment
 *
 * @category Class
 * @package  LINE\Webhook
 * @author   OpenAPI Generator team
 ...
 */
class ModuleContent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ModuleContent';
    ...
    */
    ...
    {
        $map = [
            AttachedModuleContent::class => 'attached',
            DetachedModuleContent::class => 'detached',
        ];
