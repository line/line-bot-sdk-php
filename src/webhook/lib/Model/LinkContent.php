 ...
 */
class LinkContent implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LinkContent';
    ...
    */
     ...
     * Sets result
     *
     * @param string $result One of the following values to indicate whether linking the account was successful or not
     *
     * @return self
     */
     ...
     * Sets nonce
     *
     * @param string $nonce Specified nonce (number used once) when verifying the user ID.
     *
     * @return self
     */
