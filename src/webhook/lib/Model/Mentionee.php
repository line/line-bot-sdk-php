 ...
 */
class Mentionee implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Mentionee';
    ...
    */
     ...
     * Sets index
     *
     * @param int $index Index position of the user mention for a character in text, with the first character being at position 0.
     *
     * @return self
     */
     ...
     * Sets length
     *
     * @param int $length The length of the text of the mentioned user. For a mention @example, 8 is the length.
     *
     * @return self
     */
    ...
    {
        $map = [
            AllMentionee::class => 'all',
            UserMentionee::class => 'user',
        ];
