...
/**
 * ImageMessageContent Class Doc Comment
 *
 * @category Class
 * @package  LINE\Webhook
 * @author   OpenAPI Generator team
...
class ImageMessageContent extends MessageContent
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ImageMessageContent';
    ...
    */
    ...
    public static function fromAssocArray(?array $data): self
    {
        ...
        if (isset($data['imageSet'])) {
            $instance->setimageSet(\LINE\Webhook\Model\ImageSet::fromAssocArray($data['imageSet']));
        }
