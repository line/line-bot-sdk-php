...
/**
 * PostbackEventAllOf Class Doc Comment
 *
 * @category Class
 * @package  LINE\Webhook
 * @author   OpenAPI Generator team
 ...
 */
class PostbackEventAllOf implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PostbackEvent_allOf';
    ...
    */
     ...
     * Sets replyToken
     *
     * @param string|null $replyToken Reply token used to send reply message to this event
     *
     * @return self
     */
