...
/**
 * UnsendDetail Class Doc Comment
 *
 * @category Class
 * @package  LINE\Webhook
 * @author   OpenAPI Generator team
 ...
 */
class UnsendDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UnsendDetail';
    ...
    */
     ...
     * Sets messageId
     *
     * @param string $messageId The message ID of the unsent message
     *
     * @return self
     */
