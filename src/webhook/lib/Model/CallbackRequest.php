...
class CallbackRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'destination' => 'string',
        'events' => '\LINE\Webhook\Model\Event[]'
    ];
    ...
    */
    ...
    public function setDestination($destination)
    {
        ...
        if ((mb_strlen($destination) > 33)) {
            throw new \InvalidArgumentException('invalid length for $destination when calling CallbackRequest., must be smaller than or equal to 33.');
        }
        if ((mb_strlen($destination) < 33)) {
            throw new \InvalidArgumentException('invalid length for $destination when calling CallbackRequest., must be bigger than or equal to 33.');
        }
        if ((!preg_match("/^U[0-9a-f]{32}$/", ObjectSerializer::toString($destination)))) {
            throw new \InvalidArgumentException("invalid value for \$destination when calling CallbackRequest., must conform to the pattern /^U[0-9a-f]{32}$/.");
        }
