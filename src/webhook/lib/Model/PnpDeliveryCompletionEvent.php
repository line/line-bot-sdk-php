...
/**
 * PnpDeliveryCompletionEvent Class Doc Comment
 *
 * @category Class
 ...
 */
class PnpDeliveryCompletionEvent extends Event
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PnpDeliveryCompletionEvent';
    ...
    */
    ...
    public static function fromAssocArray(?array $data): self
    {
        ...
        if (isset($data['delivery'])) {
            $instance->setdelivery(\LINE\Webhook\Model\PnpDelivery::fromAssocArray($data['delivery']));
        }
