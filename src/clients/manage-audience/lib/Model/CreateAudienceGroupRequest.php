...
/**
 * CreateAudienceGroupRequest Class Doc Comment
 *
 * @category Class
 ...
 */
class CreateAudienceGroupRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateAudienceGroupRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('uploadDescription', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['audiences']) && (count($this->container['audiences']) > 10000)) {
            $invalidProperties[] = "invalid value for 'audiences', number of items must be less than or equal to 10000.";
        }
     ...
     * Sets description
     *
     * @param string|null $description The audience's name. This is case-insensitive, meaning AUDIENCE and audience are considered identical. Max character limit: 120
     *
     * @return self
     */
    public function setDescription($description)
    {
        ...
        if ((mb_strlen($description) > 120)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CreateAudienceGroupRequest., must be smaller than or equal to 120.');
        }
     ...
     * Sets isIfaAudience
     *
     * @param bool|null $isIfaAudience To specify recipients by IFAs: set true. To specify recipients by user IDs: set false or omit isIfaAudience property.
     *
     * @return self
     */
    ...
    /**
     * Gets uploadDescription
     *
     * @return string|null
     */
    public function getUploadDescription()
    {
        return $this->container['uploadDescription'];
    }

    /**
     * Sets uploadDescription
     *
     * @param string|null $uploadDescription The description to register for the job (in jobs[].description).
     *
     * @return self
     */
    public function setUploadDescription($uploadDescription)
    {
        if (is_null($uploadDescription)) {
            throw new \InvalidArgumentException('non-nullable uploadDescription cannot be null');
        }
        $this->container['uploadDescription'] = $uploadDescription;
     ...
     * Sets audiences
     *
     * @param \LINE\Clients\ManageAudience\Model\Audience[]|null $audiences An array of user IDs or IFAs. Max number: 10,000
     *
     * @return self
     */
    public function setAudiences($audiences)
    {
        ...
        if ((count($audiences) > 10000)) {
            throw new \InvalidArgumentException('invalid value for $audiences when calling CreateAudienceGroupRequest., number of items must be less than or equal to 10000.');
        }
     ...
     * @return CreateAudienceGroupRequest
     */
