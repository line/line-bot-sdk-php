 ...
 */
class AddAudienceToAudienceGroupRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AddAudienceToAudienceGroupRequest';
    ...
    */
     ...
     *
     * @param string|null $uploadDescription The audience's name.
     *
     * @return self
     */
    ...
    public function setAudiences($audiences)
    {
        ...
        if ((count($audiences) > 10000)) {
            throw new \InvalidArgumentException('invalid value for $audiences when calling AddAudienceToAudienceGroupRequest., number of items must be less than or equal to 10000.');
        }
