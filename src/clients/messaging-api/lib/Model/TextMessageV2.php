...
/**
 * TextMessageV2 Class Doc Comment
 *
 * @category Class
 * @package  LINE\Clients\MessagingApi
 * @author   OpenAPI Generator team
 ...
 */
class TextMessageV2 extends Message
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TextMessageV2';
    ...
    protected static $openAPITypes = [
        'text' => 'string',
        'substitution' => 'array<string,\LINE\Clients\MessagingApi\Model\SubstitutionObject>',
        'quoteToken' => 'string'
    ];
    ...
    */
     ...
     * Gets substitution
     *
     * @return array<string,\LINE\Clients\MessagingApi\Model\SubstitutionObject>|null
     */
    ...
    public static function fromAssocArray(?array $data): self
    {
        ...
        if (isset($data['substitution'])) {
            $substitution = [];
            foreach ($data['substitution'] as $key => $value) {
                $substitution[$key] = \LINE\Clients\MessagingApi\Model\SubstitutionObject::fromAssocArray($value);
            }
            $instance->setsubstitution($substitution);
        }
