...
class SentMessage implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets quoteToken
     *
     * @param string|null $quoteToken Quote token of the message. Only included when a message object that can be specified as a quote target was sent as a push or reply message.
     *
     * @return self
     */
    ...
    /**
     * Create an instance of SentMessage from a dict (associative array)
     *
