...
class TextMessage extends Message
{
    ...
    */
     ...
     * Gets emojis
     *
     * @return \LINE\Clients\MessagingApi\Model\Emoji[]|null
     */
     ...
     * Sets emojis
     *
     * @param \LINE\Clients\MessagingApi\Model\Emoji[]|null $emojis emojis
     *
     * @return self
     */
    ...
    public static function fromAssocArray(?array $data): self
    {
        ...
        if (isset($data['emojis'])) {
            ...
            foreach ($data['emojis'] as $item) {
                $emojis[] = \LINE\Clients\MessagingApi\Model\Emoji::fromAssocArray($item);
            }
