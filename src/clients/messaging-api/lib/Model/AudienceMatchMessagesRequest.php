...
class AudienceMatchMessagesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets messages
     *
     * @param \LINE\Clients\MessagingApi\Model\Message[] $messages Destination of the message (A value obtained by hashing the telephone number, which is another value normalized to E.164 format, with SHA256).
     *
     * @return self
     */
