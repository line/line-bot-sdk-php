...
class URIAction extends Action
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('altUri', $data ?? [], null);
    }
    ...
    */
     ...
     * @return self
     */
    public function setAltUri($altUri)
    {
        if (is_null($altUri)) {
            throw new \InvalidArgumentException('non-nullable altUri cannot be null');
        }
        $this->container['altUri'] = $altUri;
