...
class FlexBlockStyle implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $getters = [
        ...
        'separatorColor' => 'getSeparatorColor'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('separatorColor', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['separatorColor'];
    }

    /**
     * Sets separatorColor
     *
     * @param string|null $separatorColor separatorColor
     *
     * @return self
     */
    public function setSeparatorColor($separatorColor)
    {
        if (is_null($separatorColor)) {
            throw new \InvalidArgumentException('non-nullable separatorColor cannot be null');
        }
        $this->container['separatorColor'] = $separatorColor;
    ...
    public static function fromAssocArray(?array $data): self
    {
        ...
        if (isset($data['separator'])) {
            $instance->setseparator($data['separator']);
        }
        if (isset($data['separatorColor'])) {
            $instance->setseparatorColor($data['separatorColor']);
        }
