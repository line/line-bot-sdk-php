...
class Limit implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    /**
     * Gets upToRemainingQuota
     *
     * @return bool|null
     */
    public function getUpToRemainingQuota()
    {
        return $this->container['upToRemainingQuota'];
    }

    /**
     * Sets upToRemainingQuota
     *
     * @param bool|null $upToRemainingQuota If true, the message will be sent within the maximum number of deliverable messages. The default value is `false`.  Targets will be selected at random.
     *
     * @return self
     */
    public function setUpToRemainingQuota($upToRemainingQuota)
    {
        if (is_null($upToRemainingQuota)) {
