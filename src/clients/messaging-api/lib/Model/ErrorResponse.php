...
class ErrorResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Gets details
     *
     * @return \LINE\Clients\MessagingApi\Model\ErrorDetail[]|null
     */
     ...
     * Sets details
     *
     * @param \LINE\Clients\MessagingApi\Model\ErrorDetail[]|null $details An array of error details. If the array is empty, this property will not be included in the response.
     *
     * @return self
     */
    ...
    public static function fromAssocArray(?array $data): self
    {
        ...
        if (isset($data['details'])) {
            ...
            foreach ($data['details'] as $item) {
                $details[] = \LINE\Clients\MessagingApi\Model\ErrorDetail::fromAssocArray($item);
            }
