...
class MarkMessagesAsReadRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    /**
     * Create an instance of MarkMessagesAsReadRequest from a dict (associative array)
     *
    ...
    public static function fromAssocArray(?array $data): self
    {
        ...
        if (isset($data['chat'])) {
            $instance->setchat(\LINE\Clients\MessagingApi\Model\ChatReference::fromAssocArray($data['chat']));
        }
