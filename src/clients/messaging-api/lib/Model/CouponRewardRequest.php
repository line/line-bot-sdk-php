...
/**
 * CouponRewardRequest Class Doc Comment
 *
 * @category Class
 * @package  LINE\Clients\MessagingApi
 * @author   OpenAPI Generator team
 ...
 */
class CouponRewardRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CouponRewardRequest';
    ...
    */
    ...
    public static function fromAssocArray(?array $data): self
    {
        ...
        $discriminatorMap = [
            'cashBack' => CouponCashBackRewardRequest::class,
'discount' => CouponDiscountRewardRequest::class,
'free' => CouponFreeRewardRequest::class,
'gift' => CouponGiftRewardRequest::class,
'others' => CouponOthersRewardRequest::class,
        ];
