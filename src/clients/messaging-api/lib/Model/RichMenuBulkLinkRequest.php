    ...
    */
    ...
    public function setUserIds($userIds)
    {
        ...
        if ((count($userIds) > 500)) {
            throw new \InvalidArgumentException('invalid value for $userIds when calling RichMenuBulkLinkRequest., number of items must be less than or equal to 500.');
        }
        if ((count($userIds) < 1)) {
            throw new \InvalidArgumentException('invalid length for $userIds when calling RichMenuBulkLinkRequest., number of items must be greater than or equal to 1.');
        }
