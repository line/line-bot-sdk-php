...
/**
 * CashBackPriceInfoResponse Class Doc Comment
 *
 * @category Class
 * @package  LINE\Clients\MessagingApi
 * @author   OpenAPI Generator team
 ...
 */
class CashBackPriceInfoResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CashBackPriceInfoResponse';
    ...
    */
     ...
     * @return CashBackPriceInfoResponse
     */
    public static function fromAssocArray(?array $data): self
    {
        ...
        $discriminatorMap = [
            'fixed' => CashBackFixedPriceInfoResponse::class,
'percentage' => CashBackPercentagePriceInfoResponse::class,
        ];
