...
class NarrowcastProgressResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'failedDescription' => 'setFailedDescription',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('targetCount', $data ?? [], null);
        $this->setIfExists('failedDescription', $data ?? [], null);
    ...
    */
     ...
     * Sets successCount
     *
     * @param int|null $successCount The number of users who successfully received the message.
     *
     * @return self
     */
     ...
     * Sets failureCount
     *
     * @param int|null $failureCount The number of users who failed to send the message.
     *
     * @return self
     */
     ...
     * Sets targetCount
     *
     * @param int|null $targetCount The number of intended recipients of the message.
     *
     * @return self
     */
    public function setTargetCount($targetCount)
    {
        if (is_null($targetCount)) {
            throw new \InvalidArgumentException('non-nullable targetCount cannot be null');
        }
    ...
    /**
     * Gets failedDescription
     *
     * @return string|null
     */
    public function getFailedDescription()
    {
        return $this->container['failedDescription'];
    }

    /**
     * Sets failedDescription
     *
     * @param string|null $failedDescription The reason the message failed to be sent. This is only included with a `phase` property value of `failed`.
     *
     * @return self
     */
    public function setFailedDescription($failedDescription)
    {
        if (is_null($failedDescription)) {
            throw new \InvalidArgumentException('non-nullable failedDescription cannot be null');
        }
        $this->container['failedDescription'] = $failedDescription;
