...
/**
 * SubscribedMembershipPlan Class Doc Comment
 *
 * @category Class
 ...
 */
class SubscribedMembershipPlan implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubscribedMembershipPlan';
    ...
    */
    ...
    public function setBenefits($benefits)
    {
        ...
        if ((count($benefits) < 1)) {
            throw new \InvalidArgumentException('invalid length for $benefits when calling SubscribedMembershipPlan., number of items must be greater than or equal to 1.');
        }
    ...
    /**
     * Create an instance of SubscribedMembershipPlan from a dict (associative array)
     *
