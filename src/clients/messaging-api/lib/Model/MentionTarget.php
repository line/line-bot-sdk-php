...
/**
 * MentionTarget Class Doc Comment
 *
 * @category Class
 * @package  LINE\Clients\MessagingApi
 * @author   OpenAPI Generator team
 ...
 */
class MentionTarget implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MentionTarget';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type Target to be mentioned
     *
     * @return self
     */
    ...
    {
        $map = [
            AllMentionTarget::class => 'all',
            UserMentionTarget::class => 'user',
        ];
    ...
    /**
     * Create an instance of MentionTarget from a dict (associative array)
     *
    ...
    public static function fromAssocArray(?array $data): self
    {
        ...
        $discriminatorMap = [
            'all' => AllMentionTarget::class,
'user' => UserMentionTarget::class,
        ];
