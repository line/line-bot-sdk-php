...
/**
 * MarkMessagesAsReadByTokenRequest Class Doc Comment
 *
 * @category Class
 * @package  LINE\Clients\MessagingApi
 * @author   OpenAPI Generator team
 ...
 */
class MarkMessagesAsReadByTokenRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MarkMessagesAsReadByTokenRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['markAsReadToken'] === null) {
            $invalidProperties[] = "'markAsReadToken' can't be null";
        }
     ...
     *
     * @param string $markAsReadToken Token used to mark messages as read.
     *
     * @return self
     */
    ...
    /**
     * Create an instance of MarkMessagesAsReadByTokenRequest from a dict (associative array)
     *
     * @internal This method is intended to be used internally only for now.
     *
     * @param array|null $data Associative array of property values
     * @return MarkMessagesAsReadByTokenRequest
     */
