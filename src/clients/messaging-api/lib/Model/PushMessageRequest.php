...
class PushMessageRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     *
     * @param string[]|null $customAggregationUnits List of aggregation unit name. Case-sensitive. This functions can only be used by corporate users who have submitted the required applications.
     *
     * @return self
     */
