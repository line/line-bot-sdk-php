...
class GetAggregationUnitNameListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['customAggregationUnits'] === null) {
            $invalidProperties[] = "'customAggregationUnits' can't be null";
        }
     ...
     *
     * @param string[] $customAggregationUnits An array of strings indicating the names of aggregation units used this month.
     *
     * @return self
     */
