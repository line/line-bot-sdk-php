 ...
 */
class LiffView implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LiffView';
    ...
    */
     ...
     * Sets type
     *
     * @param string $type Size of the LIFF app view. Specify one of these values: - compact - tall - full
     *
     * @return self
     */
     ...
     * Sets url
     *
     * @param string $url Endpoint URL. This is the URL of the web app that implements the LIFF app (e.g. https://example.com). Used when the LIFF app is launched using the LIFF URL. The URL scheme must be https. URL fragments (#URL-fragment) can't be specified.
     *
     * @return self
     */
    ...
    /**
     * Create an instance of LiffView from a dict (associative array)
     *
