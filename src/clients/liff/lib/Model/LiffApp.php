 ...
 */
class LiffApp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'LiffApp';
    ...
    {
        $this->setIfExists('liffId', $data ?? [], null);
    ...
    */
     ...
     * @return string|null
     */
    public function getLiffId()
    {
        return $this->container['liffId'];
    }

    /**
     * Sets liffId
     *
     * @param string|null $liffId LIFF app ID
     *
     * @return self
     */
    public function setLiffId($liffId)
    {
        if (is_null($liffId)) {
            throw new \InvalidArgumentException('non-nullable liffId cannot be null');
        }
        $this->container['liffId'] = $liffId;
     ...
     * Sets description
     *
     * @param string|null $description Name of the LIFF app
     *
     * @return self
     */
     ...
     *
     * @param string|null $permanentLinkPattern How additional information in LIFF URLs is handled. concat is returned.
     *
     * @return self
     */
