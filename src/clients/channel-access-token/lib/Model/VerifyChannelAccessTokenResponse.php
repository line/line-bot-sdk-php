...
class VerifyChannelAccessTokenResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets clientId
     *
     * @param string $clientId The channel ID for which the channel access token was issued.
     *
     * @return self
     */
     ...
     * Sets expiresIn
     *
     * @param int $expiresIn Number of seconds before the channel access token expires.
     *
     * @return self
     */
