 ...
 */
class GetRichMenuInsightSummaryResponseBounds implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetRichMenuInsightSummaryResponseBounds';
    ...
    */
     ...
     * Sets x
     *
     * @param int $x The x coordinate of the top-left corner of the target area.
     *
     * @return self
     */
     ...
     * Sets y
     *
     * @param int $y The y coordinate of the top-left corner of the target area.
     *
     * @return self
     */
     ...
     * Sets width
     *
     * @param int $width The width of the target area.
     *
     * @return self
     */
     ...
     * Sets height
     *
     * @param int $height The height of the target area.
     *
     * @return self
     */
    ...
    /**
     * Create an instance of GetRichMenuInsightSummaryResponseBounds from a dict (associative array)
     *
