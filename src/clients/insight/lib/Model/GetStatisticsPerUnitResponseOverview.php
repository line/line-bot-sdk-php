 ...
 */
class GetStatisticsPerUnitResponseOverview implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetStatisticsPerUnitResponseOverview';
