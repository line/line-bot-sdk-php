...
class SendButtonTemplateTest extends \PHPUnit_Framework_TestCase
{
    public function testReplyButtonTemplateWithImageTitle()
    {
    ...
    public function testReplyButtonTemplateNoImageNoTitle()
    {
        $mock = function ($testRunner, $httpMethod, $url, $data) {
            /** @var \PHPUnit_Framework_TestCase $testRunner */
            $testRunner->assertEquals('POST', $httpMethod);
    ...
    public function testPushButtonTemplateWithImageTitle()
    {
        $mock = function ($testRunner, $httpMethod, $url, $data) {
            /** @var \PHPUnit_Framework_TestCase $testRunner */
            $testRunner->assertEquals('POST', $httpMethod);
    ...
    public function testPushButtonTemplateNoImageNoTitle()
    {
        $mock = function ($testRunner, $httpMethod, $url, $data) {
            /** @var \PHPUnit_Framework_TestCase $testRunner */
            $testRunner->assertEquals('POST', $httpMethod);
